...
G_5 = nx.Graph()
A5= [(2,3),(2,4),(2,5),(3,4),(3,5),(4,5),(4,6),(5,6)]
G_5.add_edges_from(A5)

#Graphe g_6

G_6 = nx.Graph()
A6= [(4,5),(4,6),(4,8),(5,6),(6,7),(6,8),(7,8)]
...
G_7= nx.Graph()
A7= [(6,7),(6,8),(7,8),(7,9),(7,10),(7,11),(8,9),(9,10),(9,11),(10,11)]
...
nb_col[0].set_title("graphe g_1", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   #titre de sous-figure, placé en bas
...
nb_col[1].set_title("graphe g_2", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[2].set_title("graphe g_3", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[3].set_title("graphe g_4", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[4].set_title("graphe g_5", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[5].set_title("graphe g_6", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[6].set_title("graphe g_7", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
