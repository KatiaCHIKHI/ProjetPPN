...
nb_col[0].set_title("Clique max 1", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   #titre de sous-figure, placé en bas
...
nb_col[1].set_title("Clique max 2", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[2].set_title("Clique max 3", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[3].set_title("Clique max 4", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[4].set_title("Clique max 5", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[5].set_title("Clique max 6", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
...
nb_col[6].set_title("Clique max 7", fontsize=11.5, fontfamily="Times New Roman",fontweight="bold",y=0.009)   
