...
nx.draw(G_1,pos=position1, with_labels=False,ax=nb_col[0],node_size=55, node_color='black',width=1.5)  #dessiner G_1 dans la première colonne en utilisant la position 1,sans affichier les numéros des noeuds, avec des aretes d'épaisseur 1.5
...
nx.draw(G_2, pos=position2,with_labels=False, ax=nb_col[1],node_size=55,node_color='black',width=1.5)
...
nx.draw(G_4, position4, with_labels= False,nb_col[3],node_size=55, node_color='black',width=1.5)
